package it.gov.pagopa.analytics.process.config.json.jackson3;

import it.gov.pagopa.analytics.process.config.json.LocalDateTimeToOffsetDateTimeDeserializer;
