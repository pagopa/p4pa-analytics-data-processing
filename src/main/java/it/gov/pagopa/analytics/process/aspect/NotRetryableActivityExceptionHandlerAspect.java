package it.gov.pagopa.analytics.process.aspect;

import io.temporal.activity.Activity;
import io.temporal.activity.ActivityInfo;
import io.temporal.failure.ApplicationFailure;
import it.gov.pagopa.analytics.process.exception.NotRetryableActivityException;
import it.gov.pagopa.analytics.process.performancelogger.PerformanceLogger;
import it.gov.pagopa.analytics.process.performancelogger.PerformanceLoggerThresholdLevels;
...
public class NotRetryableActivityExceptionHandlerAspect {
    ...
    @Pointcut("within(it.gov.pagopa.analytics.process..activity..*)")
