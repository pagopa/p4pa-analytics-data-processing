...
with source as (
    ...
    (ac.assessment_classification_payload -> 'payload' ->> 'iud')::varchar(35) as iud,
    (ac.assessment_classification_payload -> 'payload' ->> 'iur')::varchar(35) as iur,
    ac.assessment_classification_payload -> 'payload' ->> 'iuv' as iuv,
